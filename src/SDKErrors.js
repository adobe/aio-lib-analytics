...
E('ERROR_GET_CALCULATED_METRICS_BY_ID', '%s')
E('ERROR_GET_COLLECTIONS', '%s')
E('ERROR_GET_COLLECTIONS_BY_ID', '%s')
E('ERROR_GET_DATE_RANGES', '%s')
E('ERROR_GET_DATE_RANGES_BY_ID', '%s')
E('ERROR_GET_DIMENSIONS', '%s')
E('ERROR_GET_DIMENSIONS_BY_ID', '%s')
E('ERROR_GET_METRICS', '%s')
E('ERROR_GET_METRICS_BY_ID', '%s')
